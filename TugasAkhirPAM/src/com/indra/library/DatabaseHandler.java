...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    // Database Name
    private static final String DATABASE_NAME = "ta_pam";
     ...
     * */
    public void addUser(String nama, String email, String uid, String register_date) {
        ...
        values.put(KEY_REGISTER_DATE, register_date);
    ...
    public HashMap<String, String> getUserDetails(){
        ...
        if(cursor.getCount() > 0){
            ...
            user.put("register_date", cursor.getString(4));
        }
        cursor.close();
        db.close();
        // return user
